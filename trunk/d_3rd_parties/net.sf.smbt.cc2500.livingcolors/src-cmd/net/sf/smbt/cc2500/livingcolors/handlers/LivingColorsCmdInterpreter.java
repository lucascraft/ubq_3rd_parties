...
public class LivingColorsCmdInterpreter extends AbstractCmdInterpreterImpl {
		@Override
		public synchronized  byte[] cmd2ByteArray(final Cmd cmd) {
			if (cmd instanceof LivingColorsCmd) {
				return LivingColorsCmdUtils.INSTANCE.dumpLivingColorsCmd((LivingColorsCmd)cmd);
			}
			return new byte[0];
		}
}
