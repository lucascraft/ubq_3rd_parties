...
#include "ofxGestureClassification.h"

class VectorGestureClassificationConfiguration;

typedef ofGestureClassification<std::vector<double>, VectorGestureClassificationConfiguration> ofVectorGestureClassification;
