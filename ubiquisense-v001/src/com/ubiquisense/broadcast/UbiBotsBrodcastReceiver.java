...
public class UbiBotsBrodcastReceiver extends BroadcastReceiver {
	...
	public UbiBotsBrodcastReceiver() {
		broadcastListeners = new ArrayList<IBrodcastListener>();
	}
	@Override
	public void onReceive(Context context, Intent intent) {
		Bundle extras = intent.getExtras();
		if (extras != null && extras.containsKey("/bots/fetch")) {
			String json = (String) extras.get("/bots/fetch");
			try {
